...
- `starship/` — `.config/capsule.toml` active Starship prompt config (Capsule theme — Google-inspired powerline pill style); `starship.toml` and `p10k-custom.toml` are alternate configs
